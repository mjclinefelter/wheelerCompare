...
<?php 
    ...
    cps_ajax_search_results_single();?>	
...
<div class="result-car hideOnSearch">
	...
	echo gorilla_img ($post->ID,'large'); if (!empty ( $fields['ribbon'])){ ?><div class="ribbon"><?php echo $fields['ribbon'];?></div><?php } else {} 
	echo '</div>';?>
...
<?php endwhile; else : ?>						
	...
	<div class="bottom-pagination hideOnSearch">
		...
		<p class="paging">
			<?php wp_reset_postdata(); pagination_nav(); $wp_query = NULL; $wp_query = $temp_query;?><div style="clear:both;"></div>   
        </p>
		</div>
