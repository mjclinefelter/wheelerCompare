...
<div class="form-group">
          ...
          <!-- Description -->
          <div class="form-group">
            <textarea placeholder="Enter vehicle listing description." id="gt-description" name="description" tabindex="20" cols="50" rows="10" class="textarea medium"></textarea>
          </div>
...
<!--             <input class="form-control" id="fileupload" type="file" name="images[]" class="button round secondary" tabindex="21" multiple> -->
          ...
          <!-- Security -->
            ...
            <input class="form-control" id="security_code3" name="security_code3" type="text" required autocomplete="off" tabindex="27" />
