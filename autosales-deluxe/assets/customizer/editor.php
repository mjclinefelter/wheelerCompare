...
public static function header_output() {
	...
	<style type="text/css"> 
		...
		<?php self::generate_css('.top-single-bar,.result-car,.overview,.features,#video,#contact,.nav.nav-tabs li a,.blog-comment,h3,.blog-post,.blog-post.common h1', 'background', 'widgets_background_color'); ?>
		...
		<?php self::generate_css('.featured-bottom h3,.container-fluid.footer h3,.side-widget h3.deals-week-title', 'background', 'headers_color'); ?>
        ...
        <?php self::generate_css('.inventory-right .btn-primary,.search-button,.detail-btn,.form-button,.price-single,nav#menu a:hover', 'background', 'buttons_background_color'); ?>                                           
		...
		<?php self::generate_css('nav#menu .active a,.find-wrapper,.navbar-nav .inventory .active a,nav#menu a:hover,.top-bar,.top-single-bar', 'background', 'menu_background'); ?>
		<?php self::generate_css('nav#menu .active a,.find-wrapper,nav#menu a:hover', 'border-color', 'menu_background'); ?>
		<?php self::generate_css('.find-wrapper', 'box-shadow', 'none'); ?>
		<?php self::generate_css('nav#menu .active a,.find-wrapper a,.cars-list li a,nav#menu a:hover', 'color', 'menu_text_active'); ?>
