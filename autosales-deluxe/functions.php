<?php 
	...
	require_once(AUTODEALER_INCLUDES . '/import/schedule/scheduler.php' );
	...
	require_once(AUTODEALER_INCLUDES . 'export/exporter.php' );
...
function my_get_form_options() {
	...
	'paypal_email'	=> __('sales@automaxclean.dev','language'),	
...
//    $attach_id = wp_insert_attachment($image, $image_filepath, $post_id);
//     $attach_data = wp_generate_attachment_metadata($attid, $image_filepath);
//     wp_update_attachment_metadata($attach_id, $attach_data);
//    array_push($attid, $attach_id);
...
if ( ! function_exists ( 'gorilla_img' ) ) {	
...
*/
function my_social_sharing_top($content) {
	if(is_singular() || is_home()){	
		...
		$twitterURL = 'https://twitter.com/intent/tweet?url='.$myURL.'&amp;';
		$facebookURL = 'https://www.facebook.com/sharer/sharer.php?u='.$myURL;
		$googleURL = 'https://plus.google.com/share?url='.$myURL;
		$pinterestURL = 'https://pinterest.com/pin/create/button/?url='.$myURL;
 ...
 add_shortcode('socialtop', 'my_social_sharing_top');
