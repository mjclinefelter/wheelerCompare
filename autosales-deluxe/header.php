...
<body <?php body_class(); ?>>
<div class="top-bar hidden-xs"><div class="container-fluid"><div class="title-tag"><?php $description = get_bloginfo( 'description', 'display' );
					if ( $description || is_customize_preview() ) : ?>
						<p class="top-site-description"><?php echo $description; ?></p>
					<?php endif; ?> 
</div><div class="share hidden-xs"><?php echo do_shortcode('[socialtop]');?></div></div></div>
