...
function gt_form_sell_your_car_field_year($tabindex = 0) {
  $html = "<select id=\"gt-year\" name=\"caryear\" class=\"gt-select\" tabindex=\"{$tabindex}\"><option value=\"-1\">Select Year</option>";
  $today = (int)date('Y');
  $options = array_reverse(range($today - 20, $today));
  $submitted = (isset($_SESSION['gt_form']->data['caryear'])
    && !empty($_SESSION['gt_form']->data['caryear']))
    ? $_SESSION['gt_form']->data['caryear']
    : FALSE;
...
function gt_form_sell_your_car_field_transmission($tabindex = 0) {
  $html = "<select id=\"gt-transmission\" name=\"transmission\" class=\"gt-select\" tabindex=\"{$tabindex}\"><option value=\"-1\">Select Transmission</option>";
...
function gt_form_sell_your_car_field_type($tabindex = 0) {
  $html = "<select id=\"gt-type\" name=\"type\" class=\"gt-select\" tabindex=\"{$tabindex}\"><option value=\"-1\">Select Type</option>";
